...
{
    // char userLoggedIn[200];
    char password[15];

    printf("Enter username: ");
    scanf("%199s", current_user.username);

    printf("Enter password: ");
    scanf("%14s", current_user.password);
    ...
    case 1:
        ...
        if (mysql_query(conn, user_id_query))
        {
